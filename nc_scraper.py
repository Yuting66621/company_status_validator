...
import sys
# reading the list
file_path = sys.argv[1] #'AI project - Confidential UNC Startups 10162024.xls (1).csv'
companies = pd.read_csv(file_path, encoding = 'Latin1')

# dropping duplicates
companies_unique = companies.drop_duplicates(subset='Employment Company Name')
company_names = companies_unique['Employment Company Name']
print(company_names)
